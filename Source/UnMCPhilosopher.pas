...
type TPhilosopher = class
  ...
  public
    constructor Create(Arq : TFileName);

    constructor CreatePar(Arq : TFileName; Groups : array of integer); 
...
constructor TPhilosopher.CreatePar(Arq: TFileName; Groups : array of integer);
  var i, j : integer;
  begin
  Create(Arq);
