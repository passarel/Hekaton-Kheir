...
type TNetRepVisual = class
  ...
  public
    ...
    constructor CreateFromLists(Background : TImage; NodesList, ArcsList : TStrings);
...
constructor TNetRepVisual.CreateFromLists(Background : TImage; NodesList, ArcsList : TStrings);
  begin
